...
public class BlackIronBlockBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:black_iron_block")
	public static final Block block = null;
	public BlackIronBlockBlock(OpGeneratorsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_iron_block");
		}
