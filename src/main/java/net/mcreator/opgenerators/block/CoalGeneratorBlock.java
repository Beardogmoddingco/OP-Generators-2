...
import net.mcreator.opgenerators.procedures.CoalGeneratorOnBlockRightClickedProcedure;
...
public class CoalGeneratorBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:coal_generator")
	public static final Block block = null;
	public CoalGeneratorBlock(OpGeneratorsModElements instance) {
		super(instance, 82);
	}
