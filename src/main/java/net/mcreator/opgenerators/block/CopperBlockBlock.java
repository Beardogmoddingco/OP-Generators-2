...
public class CopperBlockBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(OpGeneratorsModElements instance) {
		super(instance, 67);
	}
