...
import net.mcreator.opgenerators.item.CopperIngotItem;
...
public class CopperOreBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(OpGeneratorsModElements instance) {
		super(instance, 66);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("op_generators_:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("op_generators_:copper_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
