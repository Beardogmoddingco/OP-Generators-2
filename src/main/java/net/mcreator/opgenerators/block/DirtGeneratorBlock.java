...
import net.mcreator.opgenerators.procedures.DirtGeneratorOnBlockRightClickedProcedure;
...
public class DirtGeneratorBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:dirt_generator")
	public static final Block block = null;
	public DirtGeneratorBlock(OpGeneratorsModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				DirtGeneratorOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
