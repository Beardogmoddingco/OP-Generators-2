...
import net.mcreator.opgenerators.procedures.IronGeneratorOnBlockRightClickedProcedure;
...
public class IronGeneratorBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:iron_generator")
	public static final Block block = null;
	public IronGeneratorBlock(OpGeneratorsModElements instance) {
		super(instance, 83);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				IronGeneratorOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
