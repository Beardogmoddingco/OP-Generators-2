...
public class OsmiumBlockBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_block")
	public static final Block block = null;
	public OsmiumBlockBlock(OpGeneratorsModElements instance) {
		super(instance, 15);
	}
