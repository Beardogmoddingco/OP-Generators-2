...
public class OsmiumGeneratorBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_generator")
	public static final Block block = null;
	public OsmiumGeneratorBlock(OpGeneratorsModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("osmium_generator");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				OsmiumGeneratorOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
