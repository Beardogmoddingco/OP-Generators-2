...
public class PureEnergyBlockBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:pure_energy_block")
	public static final Block block = null;
	public PureEnergyBlockBlock(OpGeneratorsModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pure_energy_block");
		}
