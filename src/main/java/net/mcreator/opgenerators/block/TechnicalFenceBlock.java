...
public class TechnicalFenceBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_fence")
	public static final Block block = null;
	public TechnicalFenceBlock(OpGeneratorsModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("technical_fence");
		}
