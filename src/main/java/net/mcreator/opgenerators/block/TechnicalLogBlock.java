...
public class TechnicalLogBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_log")
	public static final Block block = null;
	public TechnicalLogBlock(OpGeneratorsModElements instance) {
		super(instance, 41);
	}
