...
public class TechnicalPlanksBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_planks")
	public static final Block block = null;
	public TechnicalPlanksBlock(OpGeneratorsModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("technical_planks");
		}
