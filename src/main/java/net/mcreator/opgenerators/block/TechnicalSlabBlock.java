...
public class TechnicalSlabBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_slab")
	public static final Block block = null;
	public TechnicalSlabBlock(OpGeneratorsModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("technical_slab");
		}
