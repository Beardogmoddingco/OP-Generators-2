...
public class TechnicalStairsBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_stairs")
	public static final Block block = null;
	public TechnicalStairsBlock(OpGeneratorsModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("technical_stairs");
		}
