...
public class TechnicalWoodBlock extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:technical_wood")
	public static final Block block = null;
	public TechnicalWoodBlock(OpGeneratorsModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("technical_wood");
		}
