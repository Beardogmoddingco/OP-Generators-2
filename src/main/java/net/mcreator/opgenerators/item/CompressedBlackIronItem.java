...
public class CompressedBlackIronItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:compressed_black_iron")
	public static final Item block = null;
	public CompressedBlackIronItem(OpGeneratorsModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("compressed_black_iron");
		}
