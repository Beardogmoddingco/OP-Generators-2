...
public class CopperIngotItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(OpGeneratorsModElements instance) {
		super(instance, 65);
	}
