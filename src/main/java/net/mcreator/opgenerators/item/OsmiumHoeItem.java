...
public class OsmiumHoeItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_hoe")
	public static final Item block = null;
	public OsmiumHoeItem(OpGeneratorsModElements instance) {
		super(instance, 23);
	}
