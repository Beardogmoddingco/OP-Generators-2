...
public class OsmiumIngotItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_ingot")
	public static final Item block = null;
	public OsmiumIngotItem(OpGeneratorsModElements instance) {
		super(instance, 13);
	}
