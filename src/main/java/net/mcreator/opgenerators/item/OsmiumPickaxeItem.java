...
public class OsmiumPickaxeItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_pickaxe")
	public static final Item block = null;
	public OsmiumPickaxeItem(OpGeneratorsModElements instance) {
		super(instance, 19);
	}
