...
public class OsmiumSwordItem extends OpGeneratorsModElements.ModElement {
	@ObjectHolder("op_generators_:osmium_sword")
	public static final Item block = null;
	public OsmiumSwordItem(OpGeneratorsModElements instance) {
		super(instance, 21);
	}
